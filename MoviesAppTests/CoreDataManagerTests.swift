...
final class CoreDataManagerTests: XCTestCase {
    ...
    func test_CoreDataManager_addMovies_and_fetchMovies_TopMovies() async {
        ...
        do {
            ...
            let fetchedLocal = try await coreDataManager.fetchMovies(entityType: TopMovies.self)
            expectation.fulfill()
    ...
    func test_CoreDataManager_addMovies_and_fetchMovies_UpcomingMovies() async {
        ...
        do {
            ...
            let fetchedLocal = try await coreDataManager.fetchMovies(entityType: UpcomingMovies.self)
            expectation.fulfill()
    ...
    func test_CoreDataManager_addMovies_and_fetchMovies_PopularMovies() async {
        ...
        do {
            ...
            let fetchedLocal = try await coreDataManager.fetchMovies(entityType: PopularMovies.self)
            expectation.fulfill()
    ...
    func test_CoreDataManager_addMovies_and_fetchMovies_TrendingMovies() async {
        ...
        do {
            ...
            let fetchedLocal = try await coreDataManager.fetchMovies(entityType: TrendingMovies.self)
            expectation.fulfill()
    ...
    func test_CoreDataManager_addMovies_and_fetchMovies_NowPlayingMovies() async {
        ...
        do {
            ...
            let fetchedLocal = try await coreDataManager.fetchMovies(entityType: NowPlayingMovies.self)
            expectation.fulfill()
    ...
    func test_CoreDataManager_addMovies_and_fetchMovies_SuggestedMovies() async {
        ...
        do {
            ...
            let fetchedLocal = try await coreDataManager.fetchMovies(entityType: SuggestedMovies.self)
            expectation.fulfill()
